...
def main():
    ...
    orderbook_influx = TradeInflux('http://localhost:8086', 'orderbookdb', create_db=True, numeric_type=float)
    oi_influx = TradeInflux('http://localhost:8086', 'oidb', create_db=True, numeric_type=float)
